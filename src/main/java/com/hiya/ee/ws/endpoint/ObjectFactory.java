 ...
 * generated in the com.hiya.ee.ws.endpoint package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://endpoint.ws.ee.hiya.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://endpoint.ws.ee.hiya.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.hiya.ee.ws.endpoint
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.ws.ee.hiya.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.ws.ee.hiya.com/", name = "queryWeather")
